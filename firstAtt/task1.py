...
def listcreator(firstList, secondList):
    outputFile = open('/Users/n0rthl1ght/Desktop/вгу/pyhton/firstAtt/results/outputTask1', 'w+')
    i = 0
    j = 0
...
with open('/Users/n0rthl1ght/Desktop/вгу/pyhton/firstAtt/input/inputTask1') as file:
    for line in file:
        for x in line.split():
            fList.append(int(x))
        break
